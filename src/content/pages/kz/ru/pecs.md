...
- communicative инициация коммуникацииs;
- использование PECS.
...
После прекращения active вмешательства эффекты использования PECS и communication инициация коммуникацииs не сохранялись.
...
Обзор Cochrane по communication вмешательстваs у аутичных детей с минимальной устной речью включил только один подходящий PECS рандомизированное исследование.
...
- исходный уровень;
- число самостоятельных инициация коммуникацииs;
- число подсказок;
- количество партнёра по коммуникацииs;
- использование дома;
