...
- изменить последствия behavior.

ABI часто является частью более широкого function-based plan.

## Пример

Ребёнок становится distressed во время перехода из класса в столовую.

Assessment показывает:
...
Antecedent-Based Interventions работают с условиями, которые возникают **до** поведения.

Главный принцип:

> **Не нужно менять ребёнка, если проблему можно безопаснее и разумнее решить изменением среды.**

Но environmental adaptation должна быть связана с реальной потребностью и assessment.
